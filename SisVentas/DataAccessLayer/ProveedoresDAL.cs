   ...
   public  class ProveedoresDAL
    {
        ...
        public static string insertarProveedor(Proveedor entity)
        {
        ...
        public static string updateProveedor(Proveedor original)
        {
            //Variable para almacenar el mensaje de error en caso de que ocurra alguno
            string message = string.Empty;
            ...
            using (var dbCtxTran = dbCtx.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (isDatabaseExist)
                    {
                        ...
                        var nuevo = dbCtx.Proveedors.Find(original.Id);
                        ...
                        if (nuevo != null)
                        {
                            ...
                            nuevo.RazonSocial = original.RazonSocial;
                            nuevo.SectorComercial = original.SectorComercial;
                            nuevo.Telefono= original.Telefono;
                            nuevo.TipoDocumento = original.TipoDocumento;
                            nuevo.Url = original.Url;
            ...
            using (var dbCtxTran = dbCtx.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (isDatabaseExist)
                    {
                        ...
                        var objStudent = dbCtx.Proveedors.Where(x => x.Id == ProveedorID).SingleOrDefault();

                        //Consulta para eliminar el objeto
                        dbCtx.Proveedors.Remove(objStudent);
