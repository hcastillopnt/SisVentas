...
namespace SisVentas.DataAccessLayer
{
    public class PresentacionDAL
    {
            ...
            using (var dbCtxTran = dbCtx.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (isDataBaseExist)
                    {
                        ...
                        dbCtx.Presentacions.Add(presentacion);
        ...
        #region ACTUALIZAR => PRESENTACION
            ...
            using (var dbCtxTran = dbCtx.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (isDataBaseExist)
                    {
                        ...
                        var entity = dbCtx.Presentacions.Find(presentacion.id);
        ...
        public static string removePresentacion(string nombre)
        {
            //variable para almacenar el mensaje de error en caso de que ocurra alguno
            string message = string.Empty;
            ...
            using (var dbCtxTran = dbCtx.Database.BeginTransaction())
            {
                try
                {
                    ...
                    if (isDataBaseExist)
                    {
                        ...
                        //var objPresentacion = dbCtx.Presentacions.Find(name);
                        //Opcion1
                        var objPresentacion = dbCtx.Presentacions.Where(x => x.nombre == nombre).SingleOrDefault();
        ...
        #region BUSCAR => PRESENTACION  => TODOS == NOMBE <=
        ...
        public static List<Presentacion> getAllPresentacion()
        {
            ...
            presentacions = dbCtx.Presentacions.ToList();
